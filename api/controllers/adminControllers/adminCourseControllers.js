...
//       // A user with the new courseId already exists (If the admin doesn't want to change the courseId, it means that the courseId in the body will be equal to the courseId in the params. In that case, the operation will be legal and this if will not be executed)
